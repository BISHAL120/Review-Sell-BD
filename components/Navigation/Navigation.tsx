        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <div className="group flex h-9 w-9 shrink-0 items-center justify-center gap-2 rounded-full bg-primary text-lg font-semibold text-primary-foreground md:h-8 md:w-8 md:text-base">
              ...
              <span className="sr-only">Vision IT</span>
            </div>
          </DropdownMenuTrigger>
          <DropdownMenuContent align="start">
            <DropdownMenuLabel>All Business</DropdownMenuLabel>
            <DropdownMenuSeparator />
            <DropdownMenuItem>Marketplace Review</DropdownMenuItem>
            <DropdownMenuSeparator />
            <DropdownMenuItem>Gammer Hat</DropdownMenuItem>
            <DropdownMenuSeparator />
            <DropdownMenuItem>Online Choing</DropdownMenuItem>
            <DropdownMenuSeparator />
            <DropdownMenuItem>More Business</DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
